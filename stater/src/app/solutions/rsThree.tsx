    ...
    return (
      <main className="flex px-[10vw] h-[350px] mt-[4vw] mb-[4vw] font-mono">
        ...
        <div className="flex-1 p-8 ml-[2vw">
          <h1 className="text-3xl font-bold mb-4">Instant, Feeless Ramping</h1>
          <p className="text-lg mb-6">
            Ramp into and out of a dozen currencies with no cost, and tens of thousands more with the lowest cost in the industry.
          </p>
          <ul className="list-disc pl-5 space-y-2">
            <li className="text-lg">Dozens of Chains</li>
            <li className="text-lg">Lowest Fees + Some Free</li>
            <li className="text-lg">Instant from or to Cash or Credit</li>
