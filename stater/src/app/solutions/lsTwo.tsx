    ...
    return (
      <main className="flex px-[10vw] h-[350px] mt-[4vw] mb-[4vw] ">
        ...
        <div className="flex-1 p-8 mr-[2vw]">
          <h1 className="text-3xl font-bold mb-4">Instant Universal Trading</h1>
          <p className="text-lg mb-6">
            Trade and swap through countless vendors in both DeFi and CeFi so you get the best of every world.
          </p>
          <ul className="list-disc pl-5 space-y-2">
            <li className="text-lg">Countless Vendors</li>
            <li className="text-lg">Instant Settlements</li>
            <li className="text-lg">Thousands of Currencies</li>
            <li className="text-lg">Dozens of Chains</li>
