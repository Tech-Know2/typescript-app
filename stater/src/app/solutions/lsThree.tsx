    ...
    return (
      <main className="flex px-[10vw] h-[350px] mt-[4vw] mb-[4vw] ">
        ...
        <div className="flex-1 p-8 mr-[2vw]">
          <h1 className="text-3xl font-bold mb-4">Instant, Low Fee, Asset Bridging</h1>
          <p className="text-lg mb-6">
            Move your money instantly without excessive fees so you can take advantage of every oppurtunity this world provides you.
          </p>
          <ul className="list-disc pl-5 space-y-2">
            <li className="text-lg">Lowest Fees Around</li>
